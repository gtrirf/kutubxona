...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    telegram_profile_photo = models.URLField(blank=True, null=True, default='https://thumbs.dreamstime.com/b/default-avatar-profile-icon-vector-social-media-user-image-182145777.jpg')
